...
public class InventoryClient {
     ...
     */
    public InventoryUpdateResponse updateInventory(String productCode, Integer quantity, String orderId) {
        try {
            ...
            InventoryUpdateResponse response = restTemplate.postForObject(
                    url, request, InventoryUpdateResponse.class);
