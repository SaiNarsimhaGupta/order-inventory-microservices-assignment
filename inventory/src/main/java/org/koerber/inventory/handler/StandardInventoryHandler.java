...
/**
 * Standard inventory handler that sorts batches by expiry date (earliest first)
 * and excludes expired batches.
 * Strategy: Use batches that expire soonest to minimize waste.
 */
@Component
@Slf4j
    ...
    public List<InventoryBatch> selectBatchesForDeduction(
        ...
        for (InventoryBatch batch : batches) {
            ...
            if (batch.getQuantity() > 0) {
                ...
                log.debug("Selected batch {} with quantity {}",
