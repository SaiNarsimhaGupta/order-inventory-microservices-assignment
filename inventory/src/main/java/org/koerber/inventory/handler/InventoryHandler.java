...
/**
 * Interface for inventory handling strategies. Different implementations can provide different
 * sorting and selection logic. This interface is used as Factory Pattern for extensibility.
 */
