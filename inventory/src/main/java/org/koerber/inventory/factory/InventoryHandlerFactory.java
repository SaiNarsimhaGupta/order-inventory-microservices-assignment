...
/**
 * Factory interface for creating inventory handlers. This enables the Factory Design Pattern for
 * extensibility. New handler types can be added without modifying existing code.
 */
